...
public class VampireBoyMob extends EntityMob
	{
		...
		public VampireBoyMob(World par1World)
			{
				super(par1World);
		...
		public IEntityLivingData onSpawnWithEgg(IEntityLivingData par1EntityLivingData)
			{
				...
				if (par1EntityLivingData1 == null)
					{
						par1EntityLivingData1 = new VampireBoyMob.GroupData(this.worldObj.rand.nextFloat() < ForgeModContainer.zombieBabyChance, this.worldObj.rand.nextFloat() < 0.05F, null);
					}

				if (par1EntityLivingData1 instanceof VampireBoyMob.GroupData)
					{
						VampireBoyMob.GroupData groupdata = (VampireBoyMob.GroupData)par1EntityLivingData1;
